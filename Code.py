...
#    s3connection    
	def __init__(self):
		...
		'''
		self.swift_conn = swiftclient.client.Connection(authurl='http://130.65.159.204/identity/v3',
		 user='admin', key='admin', tenant_name='admin', auth_version='3.0', 
		 os_options={'tenant_id': '3ded51c7cd024817bf47eaf49ada0f4e', 'region_name': ''}
		 )

		self.s3_client = boto3.client( 's3', aws_access_key_id='AKIAIXTSFOBGDXIWGSOA', 
			aws_secret_access_key='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',
